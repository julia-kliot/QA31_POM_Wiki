...
public class AppiumListener implements AppiumWebDriverEventListener {
    ...
    public void onException(Throwable throwable, WebDriver driver) {
        ...
        File tempor = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        int i = (int) (System.currentTimeMillis() / 1000) % 3600;
        File screen = new File("C:/Users/julia/Documents/QA/QA_Automation/QA/QA31_POM_Wiki/src/test/resources/Screenshots/screen" + i + ".png");
        logger.info("Screen with error---" + screen);

        try {
            Files.copy(tempor, screen);
